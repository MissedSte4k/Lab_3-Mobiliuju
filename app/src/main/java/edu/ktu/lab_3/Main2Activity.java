...
public class Main2Activity extends AppCompatActivity implements SensorEventListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //coordinates2 = (TextView) findViewById(R.id.coordinates2);
    ...
    View.OnClickListener StartAndStopButtonListener = new View.OnClickListener() {
                    ...
                    public void onClick(View v)
            {
                if (senAccelerometer == null) {
                    Toast.makeText(Main2Activity.this, "no sensor", Toast.LENGTH_LONG).show();
                    return;
                }

                if (InformationObtained) {
                    startAndStop.setText(getString(R.string.start));
                    senSensorManager.unregisterListener(Main2Activity.this, senAccelerometer);
                    InformationObtained = false;
                } else {
                    senSensorManager.registerListener(Main2Activity.this, senAccelerometer, SensorManager.SENSOR_DELAY_NORMAL);
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantedResults) {
        if(requestCode == REQUEST_CAMERA_PERMISSION) {
            if(grantedResults[0] == PackageManager.PERMISSION_DENIED) {
                Toast.makeText(Main2Activity.this, "Sorry!!!, you can't use app without granting permission", Toast.LENGTH_LONG).show();
                finish();
            }
        }
    }
